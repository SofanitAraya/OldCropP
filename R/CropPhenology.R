...
#fset
  ...
  nbrk=length(brk)
  plot(OFT$value, main="Offset_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(16,23,by=2), labels=seq(16,23,by=2)), zlim=c(16,23))
  ...
  crs(GUS)<-crs(ras)
  brk=seq(0,0.6, by=0.00001)
  nbrk=length(brk)
  plot(GUS$value, main="GreenUpSlope", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,0.6,by=0.1), labels=seq(0,0.6,by=0.1)),zlim=c(0,0.6))
  ...
  brk=seq(0,0.6, by=0.00001)
  nbrk=length(brk)
  plot(BDS$value, main="BrownDownSlope", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,0.6,by=0.1), labels=seq(0,0.6,by=0.1)),zlim=c(0,0.6))
  ...
  nbrk=length(brk)
  plot(BefMaxT$value, main="BeforeMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,12,by=4), labels=seq(0,12,by=2)), zlim=c(0,12))
