...
#    offsetV=AnnualTS[of] 
  ...
  nbrk=length(brk)
  lblbrk=brk
  plot(MT$value, main="Max_T", breaks=brk, col=rev(terrain.colors(nbrk)), lab.breaks=lblbrk, zlim=c(8,19))
  ...
  nbrk=length(brk)
  plot(MV$value, main="Max_V", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,1,by=0.1), labels=seq(0,1,by=0.1)), zlim=c(0,1))
  ...
  nbrk=length(brk)
  plot(AT$value, main="TINDVI", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,8,by=1), labels=seq(0,8,by=1)), zlim=c(0,8))
  ...
  brk=seq(0,8, by=0.001)
  nbrk=length(brk)
  plot(AA$value, main="TINDVIAfterMax", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,8,by=1), labels=seq(0,8,by=1)), zlim=c(8,19))
  ...
  brk=seq(0,8, by=0.001)
  nbrk=length(brk)
  plot(AB$value, main="TINDVIBeforeMax", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,8,by=1), labels=seq(0,8,by=1)), zlim=c(8,19))
  writeRaster(AB$value, "TINDVIBeforeMax.img", overwrite=TRUE)
  
  OT=rasterFromXYZ(Onset_Time)
  crs(OT)<-crs(ras)
  brk=seq(7,12, by=0.01)
  nbrk=length(brk)
  plot(OT$value, main="Onset_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(7,12,by=1), labels=seq(7,12,by=1)), zlim=c(7,12))
  ...
  nbrk=length(brk)
  crs(OV)<-crs(ras)
  plot(OV$value, main="Onset_V", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,1,by=0.1), labels=seq(0,1,by=0.1)), zlim=c(0,1))
  writeRaster(OV$value, "Onset_V.img", overwrite=TRUE)
  
  OFT=rasterFromXYZ(Offset_Time)
  crs(OFT)<-crs(ras)
  brk=seq(15,23, by=0.01)
  nbrk=length(brk)
  plot(OFT$value, main="Offset_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(15,23,by=1), labels=seq(15,23,by=1)), zlim=c(15,23))
  ...
  brk=seq(0,1, by=0.001)
  nbrk=length(brk)
  plot(OFV$value, main="Offset_V", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,1,by=0.1), labels=seq(0,1,by=0.1)), zlim=c(0,1))
  ...
  nbrk=length(brk)
  plot(GUS$value, main="GreenUpSlope", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,1,by=0.1), labels=seq(0,1,by=0.1)),zlim=c(0,1))
  ...
  brk=seq(0,1, by=0.0001)
  nbrk=length(brk)
  plot(BDS$value, main="BrownDownSlope", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,1,by=0.1), labels=seq(0,1,by=0.1)),zlim=c(0,1))
  ...
  plot(Len$value, main="LengthGS", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(7,15,by=1), labels=seq(7,15,by=1)), zlim=c(7,15))
  
  As=rasterFromXYZ(Asymmetry)
  crs(As)<-crs(ras)
  brk=seq(-2,2, by=0.0001)
  nbrk=length(brk)
  plot(As$value, main="Asymmetry", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(-2,2,by=0.1), labels=seq(-2,2,by=0.1)), zlim=c(-2,2))
  ...
  nbrk=length(brk)
  plot(BefMaxT$value, main="BeforeMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(1,12,by=1), labels=seq(1,12,by=1)), zlim=c(1,12))
  ...
  brk=seq(1,12, by=0.01)
  nbrk=length(brk)
  plot(AftMaxT$value, main="AfterMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(1,12,by=1), labels=seq(1,12,by=1)), zlim=c(1,12))
