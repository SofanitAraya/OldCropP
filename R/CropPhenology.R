...
#    offsetV=AnnualTS[of] 
  ...
  brk=seq(0,0.5, by=0.001)
  nbrk=length(brk)
  crs(OV)<-crs(ras)
  plot(OV$value, main="Onset_V", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,0.5,by=0.1), labels=seq(0,0.5,by=0.1)), zlim=c(0,0.5))
  writeRaster(OV$value, "Onset_V.img", overwrite=TRUE)
  
  OFT=rasterFromXYZ(Offset_Time)
  crs(OFT)<-crs(ras)
  brk=seq(17,23, by=0.01)
  nbrk=length(brk)
  plot(OFT$value, main="Offset_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(17,23,by=1), labels=seq(17,23,by=1)), zlim=c(15,23))
  ...
  brk=seq(0,0.5, by=0.001)
  nbrk=length(brk)
  plot(OFV$value, main="Offset_V", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,0.5,by=0.1), labels=seq(0,0.5,by=0.1)), zlim=c(0,0.5))
  writeRaster(OFV$value, "Offset_V.img", overwrite=TRUE)
  
  GUS=rasterFromXYZ(GreenUpSlope)
  crs(GUS)<-crs(ras)
  brk=seq(0,0.5, by=0.0001)
  nbrk=length(brk)
  plot(GUS$value, main="GreenUpSlope", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,0.5,by=0.1), labels=seq(0,0.5,by=0.1)),zlim=c(0,0.5))
  ...
  brk=seq(0,0.5, by=0.0001)
  nbrk=length(brk)
  plot(BDS$value, main="BrownDownSlope", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,0.5,by=0.1), labels=seq(0,0.5,by=0.1)),zlim=c(0,0.5))
  ...
  plot(Len$value, main="LengthGS", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(7,15,by=2), labels=seq(7,15,by=2)), zlim=c(7,15))
  
  As=rasterFromXYZ(Asymmetry)
  crs(As)<-crs(ras)
  brk=seq(-2,2, by=0.0001)
  nbrk=length(brk)
  plot(As$value, main="Asymmetry", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(-2,2,by=1), labels=seq(-2,2,by=1)), zlim=c(-2,2))
  ...
  nbrk=length(brk)
  plot(BefMaxT$value, main="BeforeMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(1,12,by=2), labels=seq(1,12,by=2)), zlim=c(1,12))
  ...
  brk=seq(1,12, by=0.01)
  nbrk=length(brk)
  plot(AftMaxT$value, main="AfterMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(1,12,by=2), labels=seq(1,12,by=2)), zlim=c(1,12))
