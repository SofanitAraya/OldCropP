...
#    offsetV=AnnualTS[of] 
  ...
  nbrk=length(brk)
  plot(OT$value, main="Onset_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(6,13,by=1), labels=seq(6,13,by=1)), zlim=c(6,13))
  ...
  nbrk=length(brk)
  lblbrk=brk
  plot(MT$value, main="Max_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(6,22,by=2), labels=seq(6,22,by=2)),zlim=c(6,22))
  ...
  nbrk=length(brk)
  plot(OFT$value, main="Offset_T", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(14,23,by=1), labels=seq(14,23,by=1)), zlim=c(14,23))
  ...
  nbrk=length(brk)
  plot(BefMaxT$value, main="BeforeMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(1,17,by=2), labels=seq(1,17,by=2)), zlim=c(1,17))
  ...
  brk=seq(1,17, by=0.01)
  nbrk=length(brk)
  plot(AftMaxT$value, main="AfterMaxT", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(1,17,by=2), labels=seq(1,17,by=2)), zlim=c(1,17))
  ...
  plot(Len$value, main="LengthGS", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,17,by=2), labels=seq(0,17,by=2)), zlim=c(0,17))

  AA=rasterFromXYZ(Area_After)
  crs(AA)<-crs(ras)
  brk=seq(0,9, by=0.0001)
  nbrk=length(brk)
  plot(AA$value, main="TINDVIAfterMax", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,9,by=2), labels=seq(0,9,by=2)), zlim=c(0,9))
  ...
  brk=seq(0,9, by=0.0001)
  nbrk=length(brk)
  plot(AB$value, main="TINDVIBeforeMax", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,9,by=2), labels=seq(0,9,by=2)), zlim=c(0,9))
  writeRaster(AB$value, "TINDVIBeforeMax.img", overwrite=TRUE)


  AT=rasterFromXYZ(Area_Total)
  crs(AT)<-crs(ras)
  brk=seq(0,9, by=0.001)
  nbrk=length(brk)
  plot(AT$value, main="TINDVI", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(0,9,by=2), labels=seq(0,9,by=2)), zlim=c(0,9))
  ...
  nbrk=length(brk)
  plot(As$value, main="Asymmetry", breaks=brk, col=rev(terrain.colors(nbrk)), axis.arg=list(at=seq(-6.0,6.0,by=2), labels=seq(-6.0,6.0,by=2)), zlim=c(-6,6))
